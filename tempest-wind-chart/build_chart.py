...
def build_chart(data_path, output_path, no_current_conditions=False):
    ...
    # row layout. A no_current_conditions (archive) day has no stat
    ...
    if times:
        ...
        # no_current_conditions (complete, past) day: its line already
...
def main():
    args = parse_args()
    build_chart(args.data, args.output, args.no_current_conditions)
