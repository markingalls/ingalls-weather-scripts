...
wind observations, then renders and atomically publishes
hermiston_wind.png with the day's peak gust marked.
...
OUTPUT_NAME = "hermiston_wind.png"
...
def main():
    ...
    try:
        ...
        env = os.environ.copy()
        obs_path = os.path.join(BASE_DIR, "tempest_wind_obs.json")
