...
On the droplet, deploy/publish_daily.py maintains the actual published
5-day archive (hermiston_temp_day{1..5}.png) going forward, one day at a
time via nightly rotation -- this script is for local testing, or for
backfilling all 5 days immediately after first deploying rather than
waiting 5 days for the archive to fill in naturally (copy its 5 output
PNGs into /var/www/images as hermiston_temp_day{1..5}.png, oldest as
day5).
