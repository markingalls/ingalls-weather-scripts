...
detections over the Columbia Basin and writes lightning_last2h.json. Run
this before build_map.py any time you want the map to reflect right-now
conditions instead of a stale snapshot -- this is the real-time
companion to ../columbia-basin-lightning-map (24-hour lookback); see
that project's fetch_lightning.py for the fuller write-up of the data
source.
...
each file, so no satellite-projection math is needed.
"""
import argparse
import json
