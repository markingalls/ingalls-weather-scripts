#!/usr/bin/env python3
"""
Cron entry point for the droplet deployment. Fetches the last 2 hours of
...
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))  # columbia-basin-lightning-realtime-map/
...
def main():
    ...
    try:
        ...
        lightning_path = os.path.join(BASE_DIR, "lightning_last2h.json")
