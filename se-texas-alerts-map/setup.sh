...
# harmless to have) uses osmium-tool -- both come from apt, not pip. The
# Poppins font used for map labels also needs installing manually here
# since it isn't packaged for apt.
set -e
